...
# Parse chrome build
set(CEF_CHROME_VERSION_BUILD_NUMBER_REGEX "#define CHROME_VERSION_BUILD ([0-9]+)")
file(STRINGS "${CEF_INCLUDE_DIR}/cef_version.h" CEF_CHROME_BUILD REGEX "${CEF_CHROME_VERSION_BUILD_NUMBER_REGEX}")
string(REGEX REPLACE
    "${CEF_CHROME_VERSION_BUILD_NUMBER_REGEX}"
    "\\1"
    CEF_CHROME_BUILD
    "${CEF_CHROME_BUILD}"
)
